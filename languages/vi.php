...
// The Vietnamese language file
// You should always use this file as a template for translating

$lang[1] = 'Không được phép truy cập';
$lang[2] = 'Máy chủ đã từ chối thực hiện yêu cầu của bạn';
$lang[3] = 'Bạn nhập vào email không hợp lệ';
$lang[4] = 'Size of parts are not numeric';
$lang[5] = 'không xác định được URL, <span class="font-black">Chỉ dùng giao thức <span class="font-blue">http</span> hoặc <span class="font-blue">https</span> hoặc <span class="font-blue">ftp</span></span>';
$lang[6] = 'Path is not specified for saving this file';
$lang[7] = 'Bạn không được phép lấy file từ <span class="font-black">%1$s (%2$s)</span>'; // %1$s = host name %2$s = host ip
$lang[8] = 'Đang chuyển hướng đến:';
$lang[9] = 'Không thể cập nhật danh sách tập tin';
$lang[10] = 'File <b>%1$s</b> (<b>%2$s</b>) Đã được lưu!<br />Thời gian: <b>%3$s</b><br />Tốc độ TB: <b>%4$s KB/s</b><br />'; // %1$s = filename %2$s = filesize %3$s = time of download %4$s = speed
$lang[11] = '<script>mail("Tập tin đã được gửi tới địa chỉ <b>%1$s</b>.", "%2$s");</script>'; // %1$s = E-mail address %2$s = filename
$lang[12] = 'Lỗi gửi file!';
$lang[13] = 'Trở về trang chính';
$lang[14] = 'Kết nối thất bại, tập tin đã bị xóa.';
$lang[15] = 'Tải lại';
$lang[16] = 'Vui lòng đổi debug mode = <b>1</b>';
$lang[17] = 'Tối đa (%1$s) link đã được lấy.'; // %1$s = Number of maximum links
$lang[18] = '%1$s Link%2$s đã kiểm tra trong %3$s giây. (Method: <b>%4$s</b>)'; // %1$s = Number of links %2$s = Plural form %3$s = seconds %4$s = method for checking links
$lang[19] = ''; // End of a plural
$lang[20] = 'Địa chỉ proxy không xài được';
$lang[21] = 'Liên kết';
$lang[22] = 'Trạng thái';
$lang[23] = 'Đang chờ';
$lang[24] = 'URL không hợp lệ';
$lang[25] = 'Đang chuẩn bị';
$lang[26] = 'Bắt đầu';
$lang[27] = 'Mất kết nối';
$lang[28] = 'Hoàn thành';
$lang[29] = 'Bắt đầu từ động chuyển';
...
$lang[37] = 'UserName';
$lang[38] = 'Password';
$lang[39] = 'Dùng Imageshack Account';
$lang[40] = 'Lưu vào';
$lang[41] = 'Đường dẫn';
$lang[42] = 'Dùng Premium Account';
