...
<link title="Rapidleech Style" href="templates/hleech/styles/rl_style_pm.css" rel="stylesheet" type="text/css" />

<title><?php
if (!isset($nn)) $nn = "\r\n";
if (!isset($page_title)) {
	echo 'Hoang leech rev. '.$rev_num;
} else {
...
pic1= new Image(); 
pic1.src="templates/hleech/images/ajax-loading.gif";
/* ]]> */
</script>
...
<body>
<center><img src="templates/hleech/images/logo_pm.gif" alt="Hoang hleech" border="0" /></center><br />